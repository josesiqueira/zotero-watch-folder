...
| **v2.2 Mode 3** | [MODE3.md](./MODE3.md) | SETUP.M3.1, DEL.1–3, RST.1–6, FDEL.1–2, FRST.1, SR.1 | **Document written, smoke-checked (plugin loads, all 11 resolver exports present). Full multi-scenario pass pending — execute before tagging `v2.2.0-alpha.1`.** Covers `.zotero-watch-trash/`, cascading-trash guard, restore matrix RST.1/2/3/4/5/6, folder delete + restore, bulk-delete prompt, smart-rules editor. |
