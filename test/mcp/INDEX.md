...
| **v2.2 Mode 3** | [MODE3.md](./MODE3.md) | SETUP.M3.1, DEL.1–3, RST.1–6, FDEL.1–2, FRST.1, SR.1 | **Document complete + two live passes (2026-05-25 partial, 2026-05-25b fuller — both against shipped v2.2.0-alpha.1).** DEL.1, DEL.1.b, DEL.2 shadow guard, RST.1, RST.3, RST.6, FDEL.1, FRST.1, SR.1 all ✅. DEL.3 / RST.2 / RST.4 / RST.5 / FDEL.2 deferred to unit-test coverage (need >10 PDFs or multi-attachment-parent setup; UT-093 / UT-094 / UT-095 / UT-420 cover). Covers `.zotero-watch-trash/`, cascading-trash guard, restore matrix RST.1/2/3/4/5/6, folder delete + restore, bulk-delete prompt, smart-rules editor. |
